...
DealButton::DealButton(): Button(){
    text_ = "DEAL";
    float x = ScreenConstants::screenWidth_ - padding_ - width_;
    float y = ScreenConstants::screenHeight_ - padding_ - height_;
...
BetButton::BetButton(): Button(){
    text_ = "BET";
    float x = ScreenConstants::screenWidth_ - padding_ - width_;
    float y = ScreenConstants::screenHeight_ - 2 * (padding_ + height_);
    bounds_ = Rectangle{x, y, width_, height_};
}
