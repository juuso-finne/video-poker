...
Sound AudioManager::draw_sound_ = Sound{};
...
void LoadSounds(){
    ...
    AudioManager::draw_sound_ = LoadSound("assets/sounds/draw.wav");
    SetSoundVolume(AudioManager::draw_sound_, 0.10);
...
void UnloadSounds(){
    ...
    UnloadSound(AudioManager::flip_sound_);
    CloseAudioDevice();
}
